//created by Ryan Nelson and Jack Morgan Spring 2016 CSCI 313
//============================================================================//
//                              Table of Contents                             //
//============================================================================//
/*
...
function load() { //alert("load()");
    ...
    queue.loadManifest([                        //standard method to load images
        {id:"sky1", src:"assets/Sky1.png"},            //day background
        {id:"sky2", src:"assets/Sky2.png"},            //night background
        {id:"startup", src:"assets/Startup.png"}       //startup image
    ]);

    ssData = {
        images: ["assets/Bird1.png"],
